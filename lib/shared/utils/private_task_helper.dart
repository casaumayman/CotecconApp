...
class PrivateTaskHelper {
  static List<PrivateTask> searchTask(
      {required List<PrivateTask> originTasks, String searchText = ""}) {
  ...
  static List<PrivateTask> sortTask(
      {required List<PrivateTask> originTasks, required SortTaskType type}) {
    switch (type) {
  ...
  static Map<SortTaskType, int Function(PrivateTask, PrivateTask)>
      _ruleOperator = {
  ...
  static List<PrivateTask> _sortByRules(
      {required List<PrivateTask> originTasks,
      List<SortTaskType> rules = const []}) {
    List<PrivateTask> sortedList = List.from(originTasks);
