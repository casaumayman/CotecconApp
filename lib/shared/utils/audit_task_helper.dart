...
class AuditTaskHelper {
  static List<AuditTask> searchTask(
      {required List<AuditTask> originTasks, String searchText = ""}) {
  ...
  static List<AuditTask> sortTask(
      {required List<AuditTask> originTasks, required SortTaskType type}) {
    switch (type) {
  ...
  static Map<SortTaskType, int Function(AuditTask, AuditTask)> _ruleOperator = {
  ...
  static List<AuditTask> _sortByRules(
      {required List<AuditTask> originTasks,
      List<SortTaskType> rules = const []}) {
    List<AuditTask> sortedList = List.from(originTasks);
